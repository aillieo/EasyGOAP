...
namespace Sample
{
    public class A_BeefChopping : DefaultAction
    {
        protected override void GetData(out Condition[] reqs, out Effect[] effs, out float cst)
        {
            ...
            effs = new Effect[]
            {
                new Effect(StateHelper.HashItemKey(ItemTypes.Beef, ItemStatus.Raw), ModifyMode.Substract, (Property)1),
                new Effect(StateHelper.HashItemKey(ItemTypes.Beef, ItemStatus.Chopped), ModifyMode.Add, (Property)1),
            };
